...
Not neccesarily. It is often much more convenient to eye-ball a spreadsheet and get an overall impression of your data. But they have *limitations* making them not ideal for large-scale analyses. Doing things by-hand only invites you to make copy-and-paste errors. Here is a classic "off-by-one" error
...
Before discussing specific things to avoid in spreadsheets, here are some general principles we should try and stick to:-
...
- Even better if the recording is automated
- Saves having to backup multiple large datasets

3) **Keep track the files in your project**

- Part of an analysis being reproducible is knowing exactly what files were used.
- Having files called `data1.xls`, `data2.xls` is not great!
- Include any information that will allow you to distinguish your files from one another
    + project or experiment name or acronym
    + Date in`YYYYMMDDD` or `YYMMDD` form
    + Conditions
    + Version number
- Avoid *special characters* `~!@#$%^&()\``;<>,[]{}'`
- Make sure everyone is working from the same data

4) **Embrace version control**

*Versioning* refers to saving new copies of your files when you make changes allowing you to reverse or roll back those changes or retrieve specific versions of your files later. Doesn't need to be involve a sophisticated software solution
